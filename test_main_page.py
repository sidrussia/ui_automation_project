...
class TestLoginFromMainPage():
    ...
    def test_guest_can_go_to_login_page(self, browser): # login link is presented
    ...
    def test_guest_should_see_login_link(self, browser): # link for login/register is here
        link = "http://selenium1py.pythonanywhere.com/"
